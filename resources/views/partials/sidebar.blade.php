    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ request()->routeIs('fasilities.*', 'rooms.*') ? 'active' : '' }}">
                    <a href="#" class="sidebar-link">
                        <i class="bi bi-stack"></i>
                        <span>Data Master</span>
                    </a>

                    <ul class="submenu {{ request()->routeIs('fasilities.*') ? 'active' : '' }}">
                        <li class="submenu-item {{ request()->routeIs('fasilities.index') ? 'active' : '' }}">
