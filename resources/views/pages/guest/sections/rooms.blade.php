 @php
     ...
     {
         if ($value >= 1000000000) {
             return number_format($value / 1000000000, 0) . 'M';
         } // milyar
         if ($value >= 1000000) {
             return number_format($value / 1000000, 0) . 'jt';
         } // juta
         if ($value >= 1000) {
             ...
             @forelse ($rooms as $room)
                 ...
                 <a href="{{ route('showRoom', Crypt::encrypt($room->id)) }}"
                     ...
                     <div class="relative">
                         ...
                         @endphp
                         @if ($photo)
                             <img src="{{ asset('storage/' . $photo->path) }}" alt="Room 1"
                                 class="w-full h-64 object-cover">
                         @else
                             <img src="https://images.unsplash.com/photo-1540518614846-7eded433c457?w=400"
                                 alt="Room 1" class="w-full h-64 object-cover">
                         @endif
                         <span
